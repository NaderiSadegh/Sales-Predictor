...
\DeclareAcronym{ARIMA}{
	short = ARIMA\index{ARIMA}, 
	long  = Autoregressive Integrated Moving Average\index{Autoregressive Integrated Moving Average!\Siehe ARIMA},
}
...
\DeclareAcronym{CSV}{
	short = CSV\index{CSV} ,
	long  = Comma Seperated Values\index{Comma Seperated Values!\Siehe {CSV}} ,
}
...
\DeclareAcronym{GARCH}{
	short = GARCH\index{GARCH},
	long  = Generalized AutoRegressive Conditional Heteroskedasticity\index{Generalized AutoRegressive Conditional Heteroskedasticity!\Siehe GARCH},
}
...
\DeclareAcronym{LGBM}{
	short = LGBM\index{LGBM}, 
	long  = Light Gradient Boosting Machine\index{Light Gradient Boosting Machine!\Siehe {LGBM}},
}
...
\DeclareAcronym{MAE}{
	short = MAE \index{MAE},
	long  = Mean Absolute Error\index{Mean Absolute Error!\Siehe MAE} ,
}

\DeclareAcronym{MSE}{
	short = MSE \index{MSE},
	long  = Mean Squared Error\index{Mean Squared Error!\Siehe MSE} ,
}
...
\DeclareAcronym{R2}{
	short = R2\index{R2} ,
	long  = R-Squared\index{R-Squared! \Siehe R2},
}
...
\DeclareAcronym{SARIMA}{
	short = SARIMA\index{SARIMA},
	long  = Seasonal AutoRegressive Integrated Moving Average\index{Seasonal AutoRegressive Integrated Moving Average!\Siehe SARIMA},
}

\DeclareAcronym{SARIMAX}{
	short = SARIMAX\index{SARIMAX},
	long  = Seasonal Autoregressive Integrated Moving Average Exogenous\index{Seasonal Autoregressive Integrated Moving Average Exogenous!\Siehe SARIMAX},
}
